...
mixin _$SignInFormState {
  ...
  bool get showErrorMessaged => throw _privateConstructorUsedError;
    ...
    return _then(_value.copyWith(
      ...
      password: null == password
          ...
          : password // ignore: cast_nullable_to_non_nullable
              as Password,
      showErrorMessaged: null == showErrorMessaged
          ? _value.showErrorMessaged
          : showErrorMessaged // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _$_SignInFormState implements _SignInFormState {
  const _$_SignInFormState(
      ...
      required this.showErrorMessaged,
  ...
  @override
  String toString() {
    return 'SignInFormState(emailAddress: $emailAddress, password: $password, showErrorMessaged: $showErrorMessaged, isSubmitting: $isSubmitting, authFailureOrSuccessOption: $authFailureOrSuccessOption)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.showErrorMessaged, showErrorMessaged) ||
                other.showErrorMessaged == showErrorMessaged) &&
  ...
  int get hashCode => Object.hash(runtimeType, emailAddress, password,
      showErrorMessaged, isSubmitting, authFailureOrSuccessOption);
...
abstract class _SignInFormState implements SignInFormState {
  const factory _SignInFormState(
      ...
      required final bool showErrorMessaged,
